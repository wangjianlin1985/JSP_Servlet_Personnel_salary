...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  ...
  <% 
  	 ...
  	 new CommDAO().delete(request,"bumenxinxi"); 
    String url = "bumenxinxi_list.jsp?1=1"; 
    String sql =  "select * from bumenxinxi where 1=1";
...
if(request.getParameter("bumen")=="" ||request.getParameter("bumen")==null ){}else{sql=sql+" and bumen like '%"+request.getParameter("bumen")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="bumenxinxi_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="bumenxinxi_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <!--qiatnalijne--> </td>
  </tr>
  	<%
  }
   %>
