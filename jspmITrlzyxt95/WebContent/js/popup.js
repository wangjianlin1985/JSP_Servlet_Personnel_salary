...
function uploadimg()
{
pop("js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("js/uploaddoc.jsp","docupload",300,77)
}

function uploaddoc2()
{
pop("js/uploaddoc2.jsp","docupload",300,77)
}

function uploaddoc3()
{
pop("js/uploaddoc3.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=js/dialogclose.gif  />';
   ...
   oDialog['style']['top']=popheight+"px"     //顶部位置
   },
...
function hsgpinglun(nbiao,nid){ 
			var pop=new Popup({ contentType:1,isReloadOnClose:false,width:550,height:250});
            pop.setContent("contentUrl","hsgpinglun.jsp?biao="+nbiao+'&id='+nid);
            pop.setContent("title","在线评论");
			//pop.popheight="450";
			 popheight = 450;
            pop.build();
            pop.show();
